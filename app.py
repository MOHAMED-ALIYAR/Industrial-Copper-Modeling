...
if selected=="PREDICT SELLING PRICE":
    ...
    with col1:
        ...
        status = st.selectbox("Select status", status_options,key=1)
        item_type = st.selectbox("Select item Type", item_type_options,key=2)
...
#status
    ...
    with col1:
        ...
        item_type = st.selectbox("Select item Type", item_type_options,key=12)
